...
| ***Add LDAP HLD*** | This ldap features describes the requirements, architecture and configuration details of ldap feature in switches for SONiC OS build image.  | [1487](https://github.com/sonic-net/SONiC/pull/1487) | Alpha` |
...
| ***Base OS upgrade to Bookworm*** | This feature upgrades SONiC's base image from Debian Bullseye to Debian Bookworm with the notable changes. | [17234](https://github.com/sonic-net/sonic-buildimage/pull/17234)  | Alpha  |
...
| ***TLS1.3 Support*** |      | [1531](https://github.com/sonic-net/SONiC/issues/1531) | [Alpha](https://github.com/sonic-net/SONiC/blob/master/doc/SONiC%20feature%20quality%20definition.md) |
...
| ***Upgrade SWSS/SyncD to debian 12*** |      | [1670](https://github.com/sonic-net/SONiC/pull/1670) | [Alpha](https://github.com/sonic-net/SONiC/blob/master/doc/SONiC%20feature%20quality%20definition.md) |
...
Please find the list of API's classified along the newly added SAI features. For further details on SAI API please refer [SAI_1.14.0 Release Notes](https://github.com/opencomputeproject/SAI/blob/master/doc/SAI_1.13.3_ReleaseNotes.md)
