...
NOTE: In the above rules, a backslash is used before % symbol related to FOR loops to avoid the github build failure. While using the actual code, remove the backslash.
```
